import scrapy
from ..items import DmmyItem
import re


class DmmySpider(scrapy.Spider):
    name = 'dmmy_spider'  # 爬虫识别名称
    allowed_domains = ['www.cmiyu.com']  # 域名范围
    start_urls = ['http://www.cmiyu.com/dmmy/']  # 爬取的url元组/列表

    def parse(self, response):  # 翻页
        preurl = 'http://www.cmiyu.com/dmmy/my18{}.html'
