import scrapy
from ..items import CymyItem
import re


class CymySpider(scrapy.Spider):
    name = 'cymy_spider'  # 爬虫识别名称
    allowed_domains = ['www.cmiyu.com']  # 域名范围
    start_urls = ['http://www.cmiyu.com/cymy/']  # 爬取的url元组/列表

    def parse(self, response):  # 翻页
        preurl = 'http://www.cmiyu.com/cymy/my20{}.html'
